...
public class MySpringBootDataAppController {
	...
	public MySpringBootDataModel createDvd(@Valid @RequestBody MySpringBootDataModel mSDM) {
	...
	public MySpringBootDataModel updatePerson(@PathVariable(value = "id") Long personID, @Valid @RequestBody MySpringBootDataModel personDetails) {
		...
		mSDM.setTitle(personDetails.getTitle());
		mSDM.setRentDate(personDetails.getRentDate());
		mSDM.setDueDate(personDetails.getDueDate());
